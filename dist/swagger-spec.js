var swaggerSpec = {
  ...
  "paths" : {
    ...
    "/escrowlist" : {
      "get" : {
        ...
        "parameters" : [ {
          ...
          "name" : "privatekey",
          "in" : "query",
          "description" : "private key for decoding data",
          "required" : false,
          "type" : "string"
        } ],
        "responses" : {
    ...
    "/offerlist" : {
      "get" : {
        "tags" : [ "Offers" ],
        "description" : "List offers that an array of aliases own. Set of aliases to look up based on alias, and private key to decrypt any data found in offer.",
